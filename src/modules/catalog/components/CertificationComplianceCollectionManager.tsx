...
import type { CertificationComplianceCollectionItemBase } from '@/modules/catalog/types/certificationCompliance';
import type { FieldConfig, TableColumn } from '@/types/resources';

type CertificationComplianceCollectionManagerProps<
  TItem extends CertificationComplianceCollectionItemBase,
...
const sortItems = <TItem extends CertificationComplianceCollectionItemBase>(items: TItem[]) =>
  [...items].sort((left, right) => left.display_order - right.display_order || left.id - right.id);

export const CertificationComplianceCollectionManager = <
  TItem extends CertificationComplianceCollectionItemBase,
  TFormValues extends Record<string, any>,
>({
  title,
  ...
  onUpdate,
  onDelete,
}: CertificationComplianceCollectionManagerProps<TItem, TFormValues>) => {
